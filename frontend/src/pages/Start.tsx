...
export default function Start() {
  ...
  const continueToApp = () => { if (addLgdOnly && lgdRows) { addLgdData(lgdRows, lgdFilename); navigate("/lgd"); return; } if (!portfolioRows || blocked) return; useInlineData(portfolioRows, portfolioFilename, lgdRows, lgdFilename); navigate("/app"); };
  const startSample = () => { useSample(); navigate("/app"); };
